...
public abstract class Zombies {
    ...
    /**
     * Áp dụng filter xanh nước biển lên ảnh khi zombie bị làm chậm
     * @param originalImage Ảnh gốc cần filter
     * @return Ảnh đã được filter (xanh) hoặc ảnh gốc nếu không bị làm chậm
     */
